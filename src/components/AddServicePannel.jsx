...
import { ADD_SERVICE_FORM_STATE, taskReducer } from '../helpers/taskReducer'

//#region STYLES

const ServicePannel = styled.form`
  position: relative;
  height: fit-content;
  width: 70%;
  display: flex;
...
const AddServicePannel = () => {

  const [formState, formDispatch] = useReducer(taskReducer,ADD_SERVICE_FORM_STATE);
  ...
  return (
    <ServicePannel>
        ...
        <FormInput>
          <Input type="text" placeholder='Numer seryjny' name={"serial"} onChange={handleInputChange}/>
          <Label>S/N</Label>
        </FormInput>
...
export default AddServicePannel
