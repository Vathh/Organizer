...
import { ADD_JOB_FORM_STATE, taskReducer } from '../helpers/taskReducer'
...
const AddJobPannel = () => {
  ...
  const [formState, formDispatch] = useReducer(taskReducer,ADD_JOB_FORM_STATE);
